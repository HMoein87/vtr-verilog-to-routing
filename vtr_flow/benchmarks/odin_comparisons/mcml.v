...
begin
    c_b1 = (loadseed_i) ? 32'b0 :
            (((r[31:0] << 13) ^ r[31:0]) >> 19);
    c_s1 = (loadseed_i) ? seed_i :
            (((r[31:0] & 32'd4294967294) << 12) ^ c_b1);
    c_b2 = (loadseed_i) ? 32'b0 :
            (((r[63:32] << 2) ^ r[63:32]) >> 25);
    c_s2 = (loadseed_i) ? {seed_i[5:0], seed_i[17], seed_i[18], seed_i[19], seed_i[20], seed_i[25:21], seed_i[31:26], seed_i[16:6]} ^ 32'd1493609598 :
            (((r[63:32] & 32'd4294967288) << 4) ^ c_b2);
    c_b3 = (loadseed_i) ? 32'b0 :
            (((r[95:64] << 3) ^ r[95:64]) >> 11);
    c_s3 = (loadseed_i) ? {seed_i[23:16], seed_i[5], seed_i[6], seed_i[7], seed_i[15:8], seed_i[4:0], seed_i[31:24]} ^ 32'd3447127471 :
            (((r[95:64] & 32'd4294967280) << 17) ^ c_b3);
end
endmodule
